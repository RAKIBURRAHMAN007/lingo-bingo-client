    ...
    return (
        <div className="bg-base-200 collapse">
            ...
            <div
                ...
                <div>
                    <p class="text-xl leading-relaxed text-white mt-4">
                        <span className="font-semibold font-mono">Goal:</span>
                    </p>
                    <p class="text-lg leading-relaxed text-white font-mono">
                    ...
                    <p class="text-lg leading-relaxed text-white mt-2 font-mono">
                    ...
                    <p class="text-xl leading-relaxed text-white  mt-4 font-mono">
